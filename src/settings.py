...
ADMINS = (
    ...
    ('Lucas Simon','lucas.simon@lucassimon.net'),
)

##############################################
# CONFIGURACOES DE EMAIL para o heroku
##############################################
DEFAULT_FROM_EMAIL = 'no-reply@eventex.com.br'
...
SECRET_KEY = '*j!f71mbfcjh&i@mip&2((r*01%35ek1tkpd#@bcm!g)fvlavj'
